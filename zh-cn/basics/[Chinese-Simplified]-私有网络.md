...
在工作目录下创建创世区块文件，拷贝以下内容，修改 `your-node-pubkey` 为第1步生成的 ***节点ID*** ，使本地节点成为共识节点参与共识。修改 `your-account-address` 为第2步生成的 ***Address***。`platon.json`内容如下：
...
注意echo命令行参数为节点私钥，需要替换成第1步生成的 ***节点私钥***。
